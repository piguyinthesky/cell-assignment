...
public class MainMenu extends Stage {
	...
	public void initBounds() {
		...
		// bounds[StageManager.CYTOSKELETON] = new Area(new Rectangle(400, 20, 190,
		// 130));
		// bounds[StageManager.SMOOTHER] = new Area(new Rectangle(400, 20, 190, 130));
		// bounds[StageManager.MITOCHONDRION] = new Area(new Rectangle(400, 20, 190,
		// 130));
	...
	public void draw(Graphics2D g) {
		...
		g.setFont(titleFont);
		drawCenteredString("The Cell: Games by Alex C", new Rectangle(0, 0, CellGame.WIDTH, CellGame.HEIGHT), g, BC);
	}
